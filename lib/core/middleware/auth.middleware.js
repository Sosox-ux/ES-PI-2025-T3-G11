...
const authMiddleware = (req, res, next) => {
    ...
    try {
        ...
        // 6. SUCESSO! O crachá é válido.
        //    Pegamos o ID do docente que estava dentro do crachá...
        //    ...e "anexamos" ele na requisição para o Controller usar.
        req.docenteId = decoded.docenteId;
        // 7. Deixa a requisição passar para o próximo passo (o Controller)
        return next();
    }
    catch (err) {
